...
\hypersetup{unicode=true,
            pdftitle={QPAD: Point Count Data Analysis Made Simple},
...
\setlength{\droptitle}{-2em}
  ...
  \title{QPAD: Point Count Data Analysis Made Simple}
...
\hypertarget{surveys}{%
\chapter{Point Count Surveys}\label{surveys}}
...
\chapter{Regression Techniques}\label{regression}}
...
\chapter{Availability}\label{availability}}
...
\hypertarget{perceptibility}{%
\chapter{Perceptibility}\label{perceptibility}}
...
\chapter{Roadside surveys}\label{roadsides}}
