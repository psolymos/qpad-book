...
\centering
```{r echo=FALSE}
include_graphics("./_images/matsuoka-2014-fig-2.png")
```
...
1992--2011 across Alaska and Canada followed the standards recommended for the count period and count radius."_

## Protocols do vary

\centering
```{r echo=FALSE}
include_graphics("./_images/barker-2015-fig-2.png")
```
